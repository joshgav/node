...
public:
    static std::unique_ptr<V8InspectorSessionImpl> create(V8DebuggerImpl*, int contextGroupId, inspector::protocol::FrontendChannel*, V8InspectorSessionClient*, const String16* state);
    ...
    void schedulePauseOnNextStatement(const String16& breakReason, std::unique_ptr<inspector::protocol::DictionaryValue> data) override;
    void cancelPauseOnNextStatement() override;
    void breakProgram(const String16& breakReason, std::unique_ptr<inspector::protocol::DictionaryValue> data) override;
    void breakProgramOnException(const String16& breakReason, std::unique_ptr<inspector::protocol::DictionaryValue> data) override;
    ...
    std::unique_ptr<inspector::protocol::Runtime::RemoteObject> wrapObject(v8::Local<v8::Context>, v8::Local<v8::Value>, const String16& groupName, bool generatePreview = false) override;
    std::unique_ptr<inspector::protocol::Runtime::RemoteObject> wrapTable(v8::Local<v8::Context>, v8::Local<v8::Value> table, v8::Local<v8::Value> columns) override;

    V8InspectorSession::Inspectable* inspectedObject(unsigned num);
    static const unsigned kInspectedObjectBufferSize = 5;

private:
    V8InspectorSessionImpl(V8DebuggerImpl*, int contextGroupId, inspector::protocol::FrontendChannel*, V8InspectorSessionClient*, const String16* state);
    inspector::protocol::DictionaryValue* agentState(const String16& name);
    ...
    inspector::protocol::UberDispatcher m_dispatcher;
    std::unique_ptr<inspector::protocol::DictionaryValue> m_state;
    ...
    inspector::protocol::Vector<std::unique_ptr<V8InspectorSession::Inspectable>> m_inspectedObjects;
};
