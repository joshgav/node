  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'src/trace/trace_broker.cc',
        'src/trace/trace_console_listener.cc',
        'src/trace/diag_utils.cc',
        ...
        'src/trace/trace_broker.h',
        'src/trace/trace_console_listener.h',
        'src/trace/diag_utils.h',
        'src/tree.h',
        'src/util.h',
        'src/util-inl.h',
        'src/util.cc',
